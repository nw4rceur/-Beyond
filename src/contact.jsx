...
export default function Contact() {
    ...
    const budgets = ['Moins de 500 €', '500 – 1 500 €', '1 500 – 5 000 €', 'Plus de 5 000 €', 'À définir ensemble'];
            ...
            <header style={{
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '.9rem 2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <a href="/" style={{ width: 90, display: 'block' }}>
                        <img src="/logo_light.png" alt="Beyond 31" style={{ width: '100%', height: 'auto', display: 'block' }} />
                    </a>
